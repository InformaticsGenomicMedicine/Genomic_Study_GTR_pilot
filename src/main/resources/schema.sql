...
test_create_date,
test_deletion_date)
FROM 'C:\gtr_data\test_version' --'C:\Users\path\to\NCBI\GTR\test_version' --after un zipping it
...
FROM 'C:\gtr_data\disease_names.txt'--'C:\Users\path\to\NCBI\GTR\disease_names.txt' --after un zipping it
